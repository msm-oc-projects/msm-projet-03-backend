...
public record CreateMessageRequest(
        @Schema(name = "rental_id", description = "Identifiant de la location", example = "1")
        ...
        @Schema(name = "user_id",
                description = "Identifiant utilisateur attendu par le front ; l'auteur réel vient du JWT",
                example = "2")
